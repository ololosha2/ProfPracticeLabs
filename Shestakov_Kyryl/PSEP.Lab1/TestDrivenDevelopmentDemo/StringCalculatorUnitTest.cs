...
namespace TestDrivenDevelopmentDemo
{
    ...
    public class StringCalculatorUnitTest
    {
        ...
        public void Add1WithEmptyArgumentTestMethod()
        {
            ...
            int actual = StringCalculator.Add1(numbers);
        ...
        public void Add2TestMethod()
        {
            ...
            int actual = StringCalculator.Add2(numbers);
        ...
        public void Add3TestMethod()
        {
            ...
            int actual = StringCalculator.Add3(numbers);
        ...
        public void Add4TestMethod()
        {
            ...
            int actual = StringCalculator.Add4(numbers);
        ...
        public void Add6WithLargeNumbersInArgumentTestMethod()
        {
            ...
            int actual = StringCalculator.Add6(numbers);
        ...
        public void Add7WithLongDelimiterTestMethod()
        {
            ...
            int actual = StringCalculator.Add7(numbers);
        ...
        public void Add8TestMethod()
        {
            ...
            int actual = StringCalculator.Add8(numbers);
